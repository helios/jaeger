...
func TestSpanReaderIndices(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			indices: []string{spanIndex + spanDataLayoutFormat, savedSpanIndex, serviceIndex + serviceDataLayoutFormat},
		},
		{
			params: SpanReaderParams{
				Client: client, Logger: logger, MetricsFactory: metricsFactory,
		...
		},
		{
			...
			indices: []string{"foo:" + indexPrefixSeparator + spanIndex + spanDataLayoutFormat, savedSpanIndex, "foo:" + indexPrefixSeparator + serviceIndex + serviceDataLayoutFormat},
		},
		{
			params: SpanReaderParams{
				Client: client, Logger: logger, MetricsFactory: metricsFactory,
		...
		},
		{
			...
			indices: []string{
				...
				"cluster_one:" + savedSpanIndex,
				"cluster_two:" + savedSpanIndex,
...
func TestSpanReader_multiRead_followUp_query(t *testing.T) {
	withSpanReader(func(r *spanReaderTest) {
		...
		firstMultiSearch.On("Index", mock.AnythingOfType("string"), savedSpanIndex).Return(firstMultiSearch)
		secondMultiSearch.On("Index", mock.AnythingOfType("string")).Return(secondMultiSearch)
		secondMultiSearch.On("Index", mock.AnythingOfType("string"), savedSpanIndex).Return(secondMultiSearch)
